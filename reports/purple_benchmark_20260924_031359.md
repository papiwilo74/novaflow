...
- **ID de Benchmark:** `bench_2e465c66`
- **ID de Campaña:** `camp_20260924_470200`
- **Fecha de Ejecución:** `2026-09-24T03:13:58.733166+00:00`
- **Flujos Totales Evaluados:** `1,080`
- **Flujos de Fondo (Ruido Benigno):** `1,000`
- **Throughput Sostenido:** `3,645.5 flujos/segundo`
...
| **Verdaderos Negativos (TN)** | `1,000` | Flujos legítimos clasificados correctamente como benignos |
...
- **MTTD Promedio (Mean Time to Detect):** `56.594 ms`
- **MTTD Mínimo:** `0.285 ms`
- **MTTD Máximo:** `220.872 ms`
- **Tiempo Total de Benchmark:** `0.2963 segundos`
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `OB-RECON-01` | OmniBreach Port & Service Scan | `T1046` | `PortScanDetector` | `MEDIUM` | `MEDIUM` | 220.87 ms | **✅ DETECTADO** |
| `OB-EXFIL-02` | OmniBreach SSRF & Data Exfiltration | `T1048` | `BandwidthExfiltrationDetector` | `HIGH` | `HIGH` | 0.54 ms | **✅ DETECTADO** |
| `OB-DOS-03` | OmniBreach SYN Flood Stress Test | `T1498` | `SynFloodDetector` | `HIGH` | `HIGH` | 4.68 ms | **✅ DETECTADO** |
| `OB-C2-04` | OmniBreach Reverse Shell Beaconing | `T1071` | `ThreatIntelMatcher` | `CRITICAL` | `CRITICAL` | 0.28 ms | **✅ DETECTADO** |
